...
{
    public class GetCarServicesByCarIdQueryHandler
        : IRequestHandler<GetCarServicesByCarIdQuery, List<CarServiceDto>>
    {
        private readonly RentCarDbContext _context;

        public GetCarServicesByCarIdQueryHandler(RentCarDbContext context)
        {
            _context = context;
        }

        public async Task<List<CarServiceDto>> Handle(
            GetCarServicesByCarIdQuery request,
